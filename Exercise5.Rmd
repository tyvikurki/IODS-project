...
tea_time <- tea %>% select(all_of(keep_columns))
...
tea_time3_what <- read.csv("https://raw.githubusercontent.com/KimmoVehkalahti/Helsinki-Open-Data-Science/master/datasets/tea_time.csv", stringsAsFactors = TRUE)
library(FactoMineR)
```
...
library(FactoMineR)
mca <- MCA(tea_time3_what, graph = FALSE)

# summary of the model
summary(mca)

# visualize MCA
plot(mca,graph.type = "classic", habillage = "quali")
